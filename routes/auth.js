...
body("alert", "Alert field is empty").isLength({
  ...
  async (req, res) => {
    ...
    try {
      ...
      <button style="border-radius: 10px;border: 1px solid black;padding: 5px 10px;"><a href="${process.env.BASE_URL}api/verificationemail/user/verification/${process.env.START_SECURE+userData +process.env.END_SECURE}" style="text-decoration: none;">Click here</a> </button>
